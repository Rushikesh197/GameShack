...
urlpatterns = [
    ...
    path('normal-user/<str:pk>/', views.NormalUserDetailView.as_view(), name='normaluser-detail'),
    ...
    path('game-developer/<str:pk>/', views.GameDeveloperDetailView.as_view(), name='gamedeveloper-detail'),
]
